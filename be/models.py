...
samples_source = DataSource(
    ...
    fields=[
        ...
        FieldDefinition(name="projectTag", type=str | None),
        FieldDefinition(name="projectName", type=list[str] | None),
        # Mandatory (ERC000053)
        ...
        FieldDefinition(name="collectionDateText", type=str | None),
        ...
        FieldDefinition(name="specimenVoucher", type=list[str] | None),
        # Relationships
        ...
        # Collection metadata
        FieldDefinition(name="sampleCollectionMethod", type=list[str] | None),
        ...
        FieldDefinition(name="proxyVoucher", type=list[str] | None),
        FieldDefinition(name="proxyBiomaterial", type=list[str] | None),
        FieldDefinition(name="bioMaterial", type=list[str] | None),
        FieldDefinition(name="cultureOrStrainId", type=str | None),
        # Original location
        FieldDefinition(name="originalCollectionDate", type=str | None),
        FieldDefinition(name="originalCollectionDateText", type=str | None),
        ...
        FieldDefinition(name="sraAccession", type=str | None),
        FieldDefinition(name="insdcCenterName", type=str | None),
        FieldDefinition(name="insdcStatus", type=str | None),
        FieldDefinition(name="insdcFirstPublic", type=str | None),
        FieldDefinition(name="insdcLastUpdate", type=str | None),
        # Transect/numeric
        ...
        # --- Environmental-DNA / ancient (ERC000059) -----------------------
        FieldDefinition(name="dataType", type=str | None, filterable=True),
        FieldDefinition(name="submitterId", type=str | None),
        FieldDefinition(name="description", type=str | None),
        FieldDefinition(name="externalReferences", type=list[str] | None),
        FieldDefinition(name="environmentalMedium", type=str | None),
        FieldDefinition(name="broadScaleEnvironmentalContext", type=str | None),
        FieldDefinition(name="localEnvironmentalContext", type=str | None),
        FieldDefinition(name="pastBroadScaleEnvironmentalContext", type=str | None),
        FieldDefinition(name="pastLocalEnvironmentalContext", type=str | None),
        FieldDefinition(name="geologicalEpoch", type=str | None),
        FieldDefinition(name="sampleAgeInferenceMethod", type=str | None),
        FieldDefinition(name="sampleAgeRangeOldestLimit", type=float | None),
        FieldDefinition(name="sampleAgeRangeYoungestLimit", type=float | None),
        FieldDefinition(name="damageTreatment", type=str | None),
        FieldDefinition(name="masterCoreSampleId", type=str | None),
        # Layer <-> taxa link
        FieldDefinition(name="age", type=int | None),
        FieldDefinition(name="taxaCount", type=int | None),
        FieldDefinition(name="readTotal", type=int | None),
        FieldDefinition(name="community", type=list[dict] | None),
        # Custom fields
